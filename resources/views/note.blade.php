        ...
        <div class="card p-4">
            <div class="row">
                ...
                @if ($note['created_at'] != $note['updated_at'])
                    <small class="text-secondary"><span class="opacity-75 me-2">Created at:</span><strong>{{date('d/m/Y H:i:s', strtotime($note['created_at']))}}</strong>  Updated at:</span><strong>{{date('d/m/Y H:i:s', strtotime($note['updated_at']))}}</strong></small>
                @else
